...
<template>
  <div class="flex flex-col mb-6">
    <div class="grid grid-cols-12 mb-2 cursor-pointer" @click="toggle">
      <div v-if="volume === 'No Volume'" class="col-span-4">{{ volume }}</div>
      <div v-else class="col-span-4">Volume {{ volume }}</div>
      <div class="text-center col-span-4">
        Ch. {{ chapters[chapters.length - 1]?.attributes.chapter }} -
    ...
    >
      <div
        v-show="isOpen"
        class="rounded flex flex-col gap-2"
        style="height: auto"
      >
