...
<template>
  <div>
    <div
      class="t l reader--immersive-buttons"
      :class="{ break: immersionBreak }"
      @click.prevent.stop="
        () => incrementPageGroup(-1, router, readStyle === ReadStyleEnum.LTR)
      "
    >
    ...
    <div
      class="b l reader--immersive-buttons"
      :class="{ break: immersionBreak }"
    ...
    <div
      class="t r reader--immersive-buttons"
      :class="{ break: immersionBreak }"
      @click.prevent.stop="
        () => incrementPageGroup(1, router, readStyle === ReadStyleEnum.LTR)
      "
    ...
    <div
      class="b r reader--immersive-buttons"
      :class="{ break: immersionBreak }"
...
.reader--immersive-buttons {
  ...
  position: fixed;
  text-shadow:
    0 2px 1px rgba(0, 0, 0, 0.73),
    0 1px 3px rgba(0, 0, 0, 0.73);
