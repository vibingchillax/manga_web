...
const { menuOpen, menuPinned, headerStyle, showMenuButton } =
...
<template>
  <div class="mw--reader-menu">
    ...
    >
      <div
        v-if="showMenuButton && $breakpoints.md.value && !immersive"
        class="reader--menu-tab"
      ...
      <div class="flex flex-col gap-y-2">
        ...
        <div class="flex items-center">
          <UIcon name="i-lucide-globe" />{{
            currentChapter?.attributes.sourceId
          }}
        </div>
        <div v-if="chapterMeta.chapterGroups" class="flex items-center">
          <UIcon name="i-lucide-users" />{{
            chapterMeta.chapterGroups.map((g) => g.attributes.name).join(", ")
          }}
        </div>
        <div v-if="chapterMeta.chapterUploader" class="flex items-center">
