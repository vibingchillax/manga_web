...
const active = ref<'pageLayout' | 'imageFit' | 'behaviors'>(props.initialTab || 'pageLayout')
</script>
<template>
    ...
    <template #body>
      <div>
        <div class="flex md:flex-row flex-col gap-4 min-h-[300px]">
          <div class="flex md:flex-col overflow-auto gap-2 items-center" style="min-width: 144px;">
            <UTabs v-model="active" :items="items" orientation="vertical" :unmount-on-hide="false" />
          </div>
          <!-- <USeparator orientation="vertical" /> -->
          <div class="flex-shrink-0 w-px bg-muted"></div>
