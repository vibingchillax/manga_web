...
<template>
  <div class="flex flex-col gap-2">
    <UButton class="align-start" :icon="viewStyleLabel?.icon" @click="switchStyles('viewStyle')">
      {{ viewStyleLabel?.label }}
    </UButton>
    <UButton v-if="viewStyle === ViewStyleEnum.DoublePage" :color="currentOffset ? 'secondary' : 'primary'"
      @click="toggleOffset">
    ...
    <UButton :icon="headerStyleLabel?.icon" @click="switchStyles('headerStyle')">
