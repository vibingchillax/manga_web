...
const pageClasses = computed(() => {
  ...
  switch (viewStyle.value) {
    case ViewStyleEnum.LongStrip:
      classes += "ls ";
      break;
    case ViewStyleEnum.WideStrip:
      classes += "ws ";
      break;
    case ViewStyleEnum.SinglePage:
      classes += "sp ";
      break;
    case ViewStyleEnum.DoublePage:
      classes += "dp ";
      break;
  }
...
<template>
  <div
    v-if="
      !managedImage.fetching && !managedImage.loaded && !managedImage.blobUrl
    "
    v-show="show"
    class="unloaded"
    @click.prevent.stop="managedImage.retry() && managedImage.retry()"
  >
    Load Image
  </div>

  <div
    v-else-if="managedImage.loaded && !managedImage.blobUrl"
    v-show="show"
    class="error"
    @click.prevent.stop="managedImage.retry && managedImage.retry()"
  >
  ...
  <div
    v-else-if="managedImage.fetching"
    v-show="show"
  ...
  <div
    v-else-if="viewStyle === ViewStyleEnum.LongStrip"
    class="mw--page"
    :class="pageClasses"
  ...
  >
    <img
      class="img"
      :class="pageClasses"
      :src="managedImage.blobUrl ?? undefined"
      :style="imageStyles"
    />
  </div>
