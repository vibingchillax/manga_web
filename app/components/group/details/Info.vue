  ...
  <div>
    <div v-if="members.length === 0" class="mb-6">
      <p class="justify-left p-4 px-6 bg-accent">
        ...
        <br /><br />
        If this group belongs to you, click <b>Claim Group</b> (...) &gt;
        <b>Claim Group</b> on mobile and fill out the form.
      </p>
    </div>
    ...
    <div v-if="leader" class="mb-6">
      ...
      <UserCard :user="toUser(leader)" show-role />
    </div>
    <div class="flex items-center mb-6">
      <div>
        ...
        <Tag v-if="inactive && !locked" no-wrapper color="warning">
          <span>
        ...
        <Tag v-else-if="locked" no-wrapper color="error"
          >Only group members</Tag
        >
        <Tag v-else no-wrapper color="primary">Anyone</Tag>
      </div>
