...
const externalSiteMap = Object.fromEntries(EXTERNAL_SITES.map(site => [site.apiCode, site]))
...
export const zMangaStatus = z.enum(["ongoing", "completed", "hiatus", "cancelled"])
export const zPublicationDemographic = z.enum(["shounen", "shoujo", "josei", "seinen"])
